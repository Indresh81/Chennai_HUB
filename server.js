...
const PRODUCTS = [
  {
    id: 'nokia-1100',
    image: '/assets/products/nokia-1100.jpg',
    name: 'Nokia 1100',
    price: 999,
    emoji: '☎️',
    accent: 'sunset',
  ...
  {
    id: 'devuda-devuda',
    image: '/assets/products/devuda-devuda.jpg',
    name: 'Devuda Devuda',
    price: 99999,
    emoji: '✨',
    accent: 'violet',
  ...
  {
    id: 'landline',
    image: '/assets/products/landline.jpg',
    name: 'Landline',
    price: 999,
    emoji: '☎',
    accent: 'ocean',
  ...
  {
    id: 'walkie-talkie',
    image: '/assets/products/walkie-talkie.jpg',
    name: 'Walkie Talkie',
    price: 5999,
    emoji: '📻',
    accent: 'lime',
  ...
  },
  {
    ...
    image: '/assets/products/samsung-s25-ultra.jpg',
  ...
  },
  {
    ...
    image: '/assets/products/redmi-note-14-pro-plus.jpg',
  ...
  {
    id: 'vivo-v50',
    image: '/assets/products/vivo-v50.jpg',
    name: 'Vivo V50',
    price: 79999,
    emoji: '◉',
    accent: 'rose',
...
server.listen(PORT, HOST, () => {
  console.log(`Chennai Mobile Hub is running at http://${HOST}:${PORT}`);
});
